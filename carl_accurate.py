...
fig_gender_pie = px.pie(
    ...
    color_discrete_sequence=['#6a11cb', '#2575fc'],  # Purple and Blue
...
color_palette = ['#6a11cb', '#2575fc', '#6a11cb', '#2575fc', '#6a11cb', '#2575fc', '#6a11cb']
...
fig_time_line = px.line(
    ...
    color_discrete_sequence=['#6a11cb']  # Single color for total visitors
)
...
st.markdown("<div class='summary-container' style='border: 2px solid #6a11cb; padding: 10px; background-color: #f0f8ff;'>", unsafe_allow_html=True)
st.dataframe(
